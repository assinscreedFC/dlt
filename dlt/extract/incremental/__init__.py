...
from dlt.common.exceptions import PipelineStateNotAvailable, SourceSectionNotAvailable, ValueErrorWithKnownValues
...
class Incremental(
    ...
    def last_value(self) -> Optional[TCursorValue]:
        ...
        if self._current_last_value is not None:
            return self._current_last_value
    ...
    def bind(self, pipe: SupportsPipe) -> "Incremental[TCursorValue]":
        ...
        if ctx.allow_external_schedulers is not None and should_join is None:
